...
def main():
    ...
    sourceImage = cv2.imread(r"D:\Desktop\Calibration-ZhangZhengyou-Method-master\图像坐标转3d\now\1.jpg")
    ...
    _, rvecs, tvecs, _ = cv2.solvePnPGeneric(worldBoxPoints, boxPoints, cameraMatrix1, distCoeffs1)
