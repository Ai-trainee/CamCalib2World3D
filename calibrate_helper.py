...
class Calibrator(object):
    ...
    def calibrate_camera(self):
        ...
        #打印point_world
        print("图片的个数：",len(points_world))
        print("point_world世界坐标：\n",points_world)
    ...
    def dedistortion(self, save_dir):
        ...
        for img_path in self.img_paths:
            ...
            image_shape = img.shape[1], img.shape[0]  # 获取图像的宽度和高度
            newcameramtx, roi = cv2.getOptimalNewCameraMatrix(self.mat_intri, self.coff_dis, image_shape, 1,
                                                              image_shape)
